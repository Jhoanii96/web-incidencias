			...
			<ul class="sidebar-menu" data-widget="tree">
				...
				<?php
					if ($data['tipouser'] == 'Técnico') {
						echo '
						<li class="header">LISTA DE INCIDENCIAS</li>
						<li><a href="' . FOLDER_PATH . '/incidencias?iq=1"><i class="fa fa-clock-o"></i> En espera</a></li>
						<li><a href="' . FOLDER_PATH . '/incidencias?iq=2"><i class="fa fa-check-square-o"></i> Atendidos</a></li>
						<li><a href="' . FOLDER_PATH . '/incidencias?iq=3"><i class="fa fa-eye"></i> En Observación</a></li>
						<li><a href="' . FOLDER_PATH . '/incidencias?iq=4"><i class="fa fa-close"></i> Anulados</a></li>
						<li><a href="' . FOLDER_PATH . '/incidencias?iq=5"><i class="fa fa-check"></i> Solucionados</a></li>
						<li><a href="' . FOLDER_PATH . '/incidencias?iq=6"><i class="fa fa-clone"></i> Mostrar todos</a></li>
						';
					} else {
						echo '
						<li class="treeview">
