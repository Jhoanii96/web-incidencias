...
<head>
	...
	<title>Editar caso de incidencia: <?= $numero ?> | USI</title>
	<!-- Bootstrap 3.3.7 -->
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							<div class="box-header with-border">
								<h3 class="box-title">EDITAR CASO: <?= $casos ?></h3>
								...
								<div class="box-body">
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<input title="Esta campo no es editable" type="text" class="form-control" value="<?= $incidencia ?>" readonly>
										</div>
										<div class="form-group">
											<label for="nombreCaso">Nombre casos</label>
											<input title="Esta campo no es editable" type="text" class="form-control" name="cas" maxlength="200" value="<?= $casos ?>">
										</div>
									</div>
								</div>
								<!-- /.box-body -->
