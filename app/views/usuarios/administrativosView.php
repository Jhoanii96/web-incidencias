...
<head>
	...
	<title>Administrativos | USI</title>
										...
										<div class="box-body">
											<table id="example1" class="table table-bordered table-hover" style="font-size: 12px;">
												...
												<tbody>
													...
													while ($rowAdmin = $data['tadministrativos']->fetch_assoc()) {
														...
														echo '
															<tr id="data-a_' . $rowAdmin['id'] . '">
																...
																<td style="display: flex;">
																	<a href="' . FOLDER_PATH . '/usuarios/edit/admin/' . $rowAdmin['id'] . '" title="Editar" style="margin-right: 7px;">
