...
<body id="fade" class="hold-transition login-page img-transition">
    ...
    <script type="text/javascript">
        var bgImageArray = [];
        bgImageArray[0] = "<?= FOLDER_PATH ?>/src/assets/img/SPL60N.jpg", bgImageArray[1] = "<?= FOLDER_PATH ?>/src/assets/img/D48DW1.jpg", bgImageArray[2] = "<?= FOLDER_PATH ?>/src/assets/img/GRSD56.jpg";
