...
$(function () {
    ...
    $demoSettings.append(
        ...
        + 'Diseño fijado'
        + '</label>'
        + '<p>Activa el diseño fijado y desactiva el diseño en caja. Los paneles de navegación estarán fijados</p>'
        + '</div>'
        // Boxed layout
        + '<div class="form-group">'
        + '<label class="control-sidebar-subheading">'
        ...
        + '</label>'
        + '<p>Alterna el estado de la barra lateral izquierda (abrir o colapsar)</p>'
        + '</div>'
        // Control Sidebar Toggle
        + '<div class="form-group">'
        + '<label class="control-sidebar-subheading">'
        + '<input type="checkbox"data-controlsidebar="control-sidebar-open"class="pull-right"/> '
        + 'Alternar la barra de configuración'
        + '</label>'
        + '<p>Alterna entre el contenido y la barra lateral derecha, emplea efectos de contenido</p>'
        + '</div>'
        // Control Sidebar Skin Toggle
        + '<div class="form-group">'
        + '<label class="control-sidebar-subheading">'
        + '<input type="checkbox"data-sidebarskin="toggle"class="pull-right"/> '
        + 'Alternar el skin de la barra de configuración'
        + '</label>'
        + '<p>Alterna el skin oscuro y claro para la barra de configuración</p>'
        + '</div>'
    )
